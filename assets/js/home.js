import { dados_das_noticias } from "../js/bd.js"
 
let vetor_das_noticias = [];
const constainer_das_noticias = document.getElementById("noticias");
...
function alternarApresentacaoDasNoticias() {
    ...
    if (vetor_das_noticias.length == 0) {
        ...
        constainer_das_noticias.innerHTML = "";
        vetor_das_noticias = [];
    }
}
...
function apresentarNoticias() {
    vetor_das_noticias.forEach(noticia => {
        ...
        constainer_das_noticias.appendChild(cartao);
    });
}